...
function DisplayCard({
  ...
  return (
    <div
      className={cn(
        "relative flex h-[10rem] w-[30rem] -skew-y-[8deg] select-none flex-col justify-between rounded-xl bg-white/70 backdrop-blur-sm px-4 py-3 transition-all duration-700 after:absolute after:-right-1 after:top-[-5%] after:h-[110%] after:w-[20rem] after:bg-gradient-to-l after:from-white after:to-transparent after:content-[''] hover:bg-white [&>*]:flex [&>*]:items-center [&>*]:gap-2",
        className
      )}
    >
      <div>
